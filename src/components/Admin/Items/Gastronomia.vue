...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // =============================================================================
      getRoom() {
        gastroService.room.get(room => {
          this.room = room;
        });
      },
      getGallery() {
        gastroService.gallery.get(gallery => {
          this.gallery = gallery;
        });
      },
      getBanner() {
        gastroService.banner.get(banner => {
      ...
      postGallery() {
        ...
        gastroService.gallery.post(inputFile, res => {
      ...
      putRoom() {
        ...
        gastroService.room.put(this.room._id, data, res => {
          this.getRoom();
      ...
      putBanner() {
        ...
        gastroService.banner.put(this.modalData._id, data, res => {
          this.getBanner();
          this.galleryModal = false;
        });
      },
      ...
      putDesc() {
        gastroService.desc.put(this.modalData, res => {
          this.getDesc();
        });
      },
      ...
      deleteGallery() {
        ...
        this.selectedSlider.forEach(element => {
          gastroService.gallery.delete(this.gallery[element]._id, res => {
            count++;
